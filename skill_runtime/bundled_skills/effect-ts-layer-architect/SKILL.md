...
description: Designs, audits, and generates production-grade Effect-TS code using correct Layer discipline, Fiber supervision, structured concurrency, and acquireRelease lifecycle patterns. Use when a task requires effect ts layer architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Designs, audits, and generates production-grade Effect-TS code using correct Layer discipline, Fiber supervision, structured concurrency, and acquireRelease lifecycle patterns. Use when a task requires effect ts layer architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
...
- "Audit this implementation using the effect ts layer architect workflow and return prioritized findings."
- "Design a production-ready effect ts layer architect solution for the attached codebase with exact file paths and tests."
- "Use effect-ts-layer-architect to review the current approach, identify risks, and propose the smallest safe upgrade."

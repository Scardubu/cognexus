...
description: Defines motion strategy, performance budgets, compositor rules, and anti-pattern detection for animation-heavy frontends. Use when a task requires motion performance architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Defines motion strategy, performance budgets, compositor rules, and anti-pattern detection for animation-heavy frontends. Use when a task requires motion performance architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

---
name: portfolio-conviction-engine
description: 'Analyzes, audits, and surgically elevates developer portfolio sites and their governing spec documents to maximize trust and conversion for dual audiences: technical evaluators (engineers, CTOs, hiring managers) and non-technical decision-makers (founders, investors, PMs). Use when a task requires portfolio conviction engine analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.'
license: MIT
...
**Use this skill when:** Analyzes, audits, and surgically elevates developer portfolio sites and their governing spec documents to maximize trust and conversion for dual audiences: technical evaluators (engineers, CTOs, hiring managers) and non-technical decision-makers (founders, investors, PMs). Use when a task requires portfolio conviction engine analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
...
- "Audit this implementation using the portfolio conviction engine workflow and return prioritized findings."
- "Design a production-ready portfolio conviction engine solution for the attached codebase with exact file paths and tests."
- "Use portfolio-conviction-engine to review the current approach, identify risks, and propose the smallest safe upgrade."

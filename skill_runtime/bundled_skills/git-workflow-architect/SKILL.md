...
description: 'Designs and generates complete Git workflow configurations: branch strategies, conventional commit setups (commitlint + commitizen + husky), PR templates, GitLens configuration, GitHub Actions CI workflows, and semantic release pipelines. Use when a task requires git workflow architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.'
license: MIT
...
**Use this skill when:** Designs and generates complete Git workflow configurations: branch strategies, conventional commit setups (commitlint + commitizen + husky), PR templates, GitLens configuration, GitHub Actions CI workflows, and semantic release pipelines. Use when a task requires git workflow architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

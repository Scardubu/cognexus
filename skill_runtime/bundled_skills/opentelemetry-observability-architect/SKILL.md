...
description: 'Designs and implements complete OpenTelemetry observability pipelines for Node.js applications: auto-instrumentation for Fastify, Prisma, BullMQ, and HTTP clients; custom spans for business logic; RED metrics; structured logging with trace correlation; and OTLP export configuration. Use when a task requires opentelemetry observability architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.'
license: MIT
...
**Use this skill when:** Designs and implements complete OpenTelemetry observability pipelines for Node.js applications: auto-instrumentation for Fastify, Prisma, BullMQ, and HTTP clients; custom spans for business logic; RED metrics; structured logging with trace correlation; and OTLP export configuration. Use when a task requires opentelemetry observability architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

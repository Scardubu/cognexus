...
description: Runs a comprehensive quality gate on frontend components covering accessibility (WCAG AA), performance (Core Web Vitals impact), testability, Storybook story generation, and TypeScript prop contract correctness. Use when a task requires component quality gate analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Runs a comprehensive quality gate on frontend components covering accessibility (WCAG AA), performance (Core Web Vitals impact), testability, Storybook story generation, and TypeScript prop contract correctness. Use when a task requires component quality gate analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

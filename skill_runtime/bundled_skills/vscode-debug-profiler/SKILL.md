...
description: Configures and guides VS Code debugging and performance profiling for Node.js, Fastify, Next.js, and frontend applications. Generates launch.json configurations, explains CPU and memory profiling workflows, identifies performance bottlenecks, and documents advanced debugger features. Use when a task requires vscode debug profiler analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Configures and guides VS Code debugging and performance profiling for Node.js, Fastify, Next.js, and frontend applications. Generates launch.json configurations, explains CPU and memory profiling workflows, identifies performance bottlenecks, and documents advanced debugger features. Use when a task requires vscode debug profiler analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
...
- "Audit this implementation using the vscode debug profiler workflow and return prioritized findings."
- "Apply the vscode debug profiler workflow in dry-run mode first, then provide exact commands and rollback steps."
- "Use vscode-debug-profiler to review the current approach, identify risks, and propose the smallest safe upgrade."

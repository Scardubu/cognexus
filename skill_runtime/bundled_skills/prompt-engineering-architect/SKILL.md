...
description: 'Designs, audits, and optimizes prompts for AI features embedded in applications: system prompts, few-shot examples, chain-of-thought instructions, structured output prompts, RAG context injection, tool descriptions, and multi-turn conversation design. Use when a task requires prompt engineering architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.'
license: MIT
...
**Use this skill when:** Designs, audits, and optimizes prompts for AI features embedded in applications: system prompts, few-shot examples, chain-of-thought instructions, structured output prompts, RAG context injection, tool descriptions, and multi-turn conversation design. Use when a task requires prompt engineering architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

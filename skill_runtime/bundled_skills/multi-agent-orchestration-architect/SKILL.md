...
description: Designs, implements, and audits multi-agent AI orchestration systems with BullMQ job chains, LLM routing, tool registries, agent state machines, and prompt injection defenses. Use when a task requires multi agent orchestration architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Designs, implements, and audits multi-agent AI orchestration systems with BullMQ job chains, LLM routing, tool registries, agent state machines, and prompt injection defenses. Use when a task requires multi agent orchestration architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

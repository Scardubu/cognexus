...
description: Audits and elevates web UI designs and frontend components to production-grade quality using Gestalt principles, WCAG AA accessibility standards, design token governance, and micro-interaction patterns inspired by Linear, Stripe, and Vercel. Use when a task requires frontend design auditor analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Audits and elevates web UI designs and frontend components to production-grade quality using Gestalt principles, WCAG AA accessibility standards, design token governance, and micro-interaction patterns inspired by Linear, Stripe, and Vercel. Use when a task requires frontend design auditor analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
...
- "Audit this implementation using the frontend design auditor workflow and return prioritized findings."
- "Design a production-ready frontend design auditor solution for the attached codebase with exact file paths and tests."
- "Use frontend-design-auditor to review the current approach, identify risks, and propose the smallest safe upgrade."

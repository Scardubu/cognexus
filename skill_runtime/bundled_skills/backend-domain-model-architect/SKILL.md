...
description: Shapes business logic into bounded contexts, aggregates, invariants, and explicit use cases using Effect-TS for typed service composition. Use when a task requires backend domain model architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Shapes business logic into bounded contexts, aggregates, invariants, and explicit use cases using Effect-TS for typed service composition. Use when a task requires backend domain model architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

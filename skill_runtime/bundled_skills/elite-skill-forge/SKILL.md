...
description: Generates elite, production-ready Claude skills (SKILL.md files) from a domain, workflow, or intent description. Use when a task requires elite skill forge analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Generates elite, production-ready Claude skills (SKILL.md files) from a domain, workflow, or intent description. Use when a task requires elite skill forge analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
...
- "Audit this implementation using the elite skill forge workflow and return prioritized findings."
- "Design a production-ready elite skill forge solution for the attached codebase with exact file paths and tests."
- "Use elite-skill-forge to review the current approach, identify risks, and propose the smallest safe upgrade."

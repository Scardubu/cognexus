---
name: agent-prompt-upgrade
description: Upgrades, refines, and version-bumps AI agent system prompts, cognitive OS configs, and multi-agent orchestration prompt layers using IEP-ELITE patterns, structured reasoning frameworks, and SCAR engineering philosophy. Use when a task requires agent prompt upgrade analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Upgrades, refines, and version-bumps AI agent system prompts, cognitive OS configs, and multi-agent orchestration prompt layers using IEP-ELITE patterns, structured reasoning frameworks, and SCAR engineering philosophy. Use when a task requires agent prompt upgrade analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

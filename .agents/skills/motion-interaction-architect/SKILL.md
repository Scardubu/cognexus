...
description: 'Designs and implements production-grade motion systems for web using Framer Motion: animation tokens, page transitions, gesture interactions, scroll-driven animations, layout animations, reduced-motion accessibility, and component choreography. Use when a task requires motion interaction architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.'
license: MIT
...
**Use this skill when:** Designs and implements production-grade motion systems for web using Framer Motion: animation tokens, page transitions, gesture interactions, scroll-driven animations, layout animations, reduced-motion accessibility, and component choreography. Use when a task requires motion interaction architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
...
- "Audit this implementation using the motion interaction architect workflow and return prioritized findings."
- "Design a production-ready motion interaction architect solution for the attached codebase with exact file paths and tests."
- "Use motion-interaction-architect to review the current approach, identify risks, and propose the smallest safe upgrade."

...
description: Designs accessibility as a system rather than a final audit. Use when a task requires accessibility system architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Designs accessibility as a system rather than a final audit. Use when a task requires accessibility system architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
...
- "Audit this implementation using the accessibility system architect workflow and return prioritized findings."
- "Design a production-ready accessibility system architect solution for the attached codebase with exact file paths and tests."
- "Use accessibility-system-architect to review the current approach, identify risks, and propose the smallest safe upgrade."

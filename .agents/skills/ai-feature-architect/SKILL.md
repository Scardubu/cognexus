...
description: 'Designs and implements production AI features using Vercel AI SDK v6: streaming chat, tool calling, structured output, RAG pipelines with pgvector, multi-model routing, and AI gateway patterns. Use when a task requires ai feature architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.'
license: MIT
...
**Use this skill when:** Designs and implements production AI features using Vercel AI SDK v6: streaming chat, tool calling, structured output, RAG pipelines with pgvector, multi-model routing, and AI gateway patterns. Use when a task requires ai feature architect analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
...
- "Audit this implementation using the ai feature architect workflow and return prioritized findings."
- "Design a production-ready ai feature architect solution for the attached codebase with exact file paths and tests."
- "Use ai-feature-architect to review the current approach, identify risks, and propose the smallest safe upgrade."

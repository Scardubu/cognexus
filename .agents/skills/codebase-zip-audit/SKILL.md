---
name: codebase-zip-audit
description: Extracts, audits, and surgically patches a Next.js / TypeScript / React production codebase uploaded as a zip file. Use when a task requires codebase zip audit analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Extracts, audits, and surgically patches a Next.js / TypeScript / React production codebase uploaded as a zip file. Use when a task requires codebase zip audit analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

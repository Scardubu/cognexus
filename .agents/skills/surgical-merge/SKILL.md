---
name: surgical-merge
description: Performs an exhaustive multi-version file or bundle comparison, produces a definitive production-ready merged output, and emits a structured audit trail with prioritized change log. Use when a task requires surgical merge analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.
license: MIT
...
**Use this skill when:** Performs an exhaustive multi-version file or bundle comparison, produces a definitive production-ready merged output, and emits a structured audit trail with prioritized change log. Use when a task requires surgical merge analysis, design, implementation, audit, debugging, or production hardening, even when the skill name is not mentioned.

# Detailed guidance: Prompt Engineering Architect
...
### Step 4 — private deliberation with concise decision rationale Prompting
...
| Unprompted private deliberation with concise decision rationale | Model gives reasoning when you want an answer | Add "Respond with only the answer, no explanation" |
